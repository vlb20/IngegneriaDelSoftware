...
public int aggiungiVoto(String docente, int matricola, int idmaterie, Date data, float voto) {//funzione che permette a un docente di inserire un voto, in una materia che insegna,
	//ad uno studente appartenente alla classe in cui insegna tale materia
